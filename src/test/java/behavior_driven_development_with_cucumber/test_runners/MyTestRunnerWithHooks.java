...
@ConfigurationParameter(key = GLUE_PROPERTY_NAME, value = "behavior_driven_development_with_cucumber.hooks, behavior_driven_development_with_cucumber.step_definitions")
...
public class MyTestRunnerWithHooks {
